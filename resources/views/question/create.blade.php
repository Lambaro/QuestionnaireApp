                    ...
                    <div class="card-body">
                        <form action="/questionnaires/{{ $questionnaire->id }}/questions" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <small id="questionHelp" class="form-text text-muted">Ask simple to the point questions
                                    ...
                                    <div>
                                        <div class="form-group">
                                            ...
                                            <input name="answers[][answer]" type="text"
                                                   ...
                                                   class="form-control" id="answer2" aria-describedby="choiceHelp"
                                    ...
                                    <div>
                                        <div class="form-group">
                                            ...
                                            <input name="answers[][answer]" type="text"
                                                   ...
                                                   class="form-control" id="answer3" aria-describedby="choiceHelp"
                                    ...
                                    <div>
                                        <div class="form-group">
                                            ...
                                            <input name="answers[][answer]" type="text"
                                                   ...
                                                   class="form-control" id="answer4" aria-describedby="choiceHelp"
